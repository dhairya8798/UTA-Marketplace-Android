...
import com.uta.market.databinding.LayoutHomeAdBinding
import com.uta.market.databinding.ProductsListItemBinding
import com.uta.market.getOfferPercentage
...
class ProductAdapter(proList: List<Any>, userLikes: List<String>, private val context: Context) :
	...
	private val sessionManager = AppSessionManager(context)
