...
import com.uta.market.ERR_UPLOAD
...
import com.uta.market.data.utils.AddProductErrors
import com.uta.market.data.utils.StoreDataStatus
import com.uta.market.getProductId
import com.uta.market.ui.AddProductViewErrors
...
class AddEditProductViewModel(application: Application) : AndroidViewModel(application) {
	...
	private val productsRepository =
		(application.applicationContext as UTAMarketApp).productsRepository
