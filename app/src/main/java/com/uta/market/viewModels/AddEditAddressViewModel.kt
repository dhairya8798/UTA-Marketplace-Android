package com.uta.market.viewModels
...
import com.uta.market.UTAMarketApp
import com.uta.market.data.Result.Error
import com.uta.market.data.Result.Success
import com.uta.market.data.AppSessionManager
import com.uta.market.data.UserData
import com.uta.market.data.utils.AddObjectStatus
import com.uta.market.data.utils.StoreDataStatus
import com.uta.market.getAddressId
import com.uta.market.isPhoneValid
import com.uta.market.isZipCodeValid
import com.uta.market.ui.AddAddressViewErrors
import kotlinx.coroutines.async
import kotlinx.coroutines.launch

class AddEditAddressViewModel(application: Application) : AndroidViewModel(application) {

	private val authRepository = (application as UTAMarketApp).authRepository

	private val sessionManager = AppSessionManager(application.applicationContext)
