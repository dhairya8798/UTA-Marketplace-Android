...
import com.uta.market.*
import com.uta.market.data.UserData
import com.uta.market.data.utils.LogInErrors
import com.uta.market.data.utils.SignUpErrors
import com.uta.market.data.utils.UserType
import com.uta.market.ui.LoginViewErrors
import com.uta.market.ui.SignUpViewErrors
...
class AuthViewModel(application: Application) : AndroidViewModel(application) {
	...
	private val productsRepository = (application as UTAMarketApp).productsRepository
	...
	private fun checkUniqueUser(uData: UserData) {
		viewModelScope.launch {
			val res = async { authRepository.checkEmailAndMobile(uData.email, uData.mobile, getApplication<UTAMarketApp>().applicationContext) }
